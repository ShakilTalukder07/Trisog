...
const Banner = () => {
    return (
        <div className='relative'>
            <div className="bg-blue-900 flex flex-col md:flex-row lg:flex-row justify-center lg:justify-evenly items-center gap-4 py-10 ">
                <div className='mb-10'>
            ...
            <div className='mx-10'>
                <div className=' flex flex-wrap gap-4 justify-center items-center bg-white p-3 rounded-md -mt-28 z-20 relative w-full'>
